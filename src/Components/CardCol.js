      ...
      <Card className={classes.root} className="cards">
        <CardActionArea>
          ...
          <CardContent>
            ...
            <br />
            <footer className="blockquote-footer" style={{ textAlign: "end" }}>
              <cite title="Source Title">Author: {datas.author}</cite>
            </footer>
          </CardContent>
        </CardActionArea>
        <CardActions>
          <footer className="blockquote-footer">
            <cite title="Source Title">{datas.source.name}</cite>
          </footer>

          <footer className="blockquote-footer">
            <cite title="Source Title">{datas.publishedAt}</cite>
          </footer>
